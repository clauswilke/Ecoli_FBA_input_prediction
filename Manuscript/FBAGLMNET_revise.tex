...
Unlimited N, normal C & 100 & 4900 & 1 C/N & 4865 & 2432 & 2433 \\
 (7N, 7C)\\
Unlimited C, normal N & 100 & 4900 & 1 C/N & 4848 & 2424 & 2424 \\
 (7C, 7N) \\
174C, 78N & 2 & 27144 & 1 C/N & 25140 & 12596 & 12544 \\
Degenerate model & 100 & 4900 & 10 C/N \\
max. Biomass and min. Absolute sum & 100 & 4900 & 10 C/N \\
\hline
\end{tabular}
}
\bigskip
...
\textbf{Substrate composition of commonly used growth media for \emph{E. coli}.}
To test prediction of commonly used growth media, we performed FBA using these substrate compositions and then used regularized regression to predict growth media from the simulated fluxes. }
\bigskip
...
\textbf{Reactions that are post transport/exchange reactions that first metabolize the substrate.}
Instead of using all the reactions in the model, we developed a degenerate model to see if sensitivity using this method is comparable to using the entire metabolic model. }
\bigskip

\centerline{
\begin{tabular}{ccc}
\textbf{Growth conditions} & \textbf{Reactions} \\
\hline
...
L-alanine & ALAR, ALATA-L,ALATA-L2\\
