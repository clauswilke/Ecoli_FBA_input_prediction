...
\textbf{Summary of all simulations performed.} Each row details the growth conditions used for flux balance analysis (FBA) and the sizes of training and test data sets for inverse prediction of growth conditions from simulated phenotypes. {\color{red}Please update/finalize this table. Add unequal C/N impurities, make sure the number of viable observation, and training and test data set sizes are always reported.}}
\bigskip
