...
FluxData1=xlsread('ArtificialCarbon.xlsx');
%FluxData1=FluxData2;
...
%         end
        ...
        subplot(7,7,2)
        scatter(FluxDataCN(1,2,:,1),FluxDataCN(1,2,:,2),50,reshape(FluxDataCNcolor(1,2,:,:),50,3),'filled');
        xlabel('Glucose');
        ylabel('Adenine');
        axis([-1000 1000 -30 30]);
        subplot(7,7,3)
        ...
        axis([-1000 1000 -30 30]);
        subplot(7,7,22)
        scatter(FluxDataCN(4,1,1:41,1),FluxDataCN(4,1,1:41,2),50,reshape(FluxDataCNcolor(4,1,1:41,:),41,3),'filled');
        xlabel('Acetate');
        ylabel('Ammonia');
        axis([-1000 1000 -30 30]);
        subplot(7,7,23)
        scatter(FluxDataCN(4,2,1:43,1),FluxDataCN(4,2,1:43,2),50,reshape(FluxDataCNcolor(4,2,1:43,:),43,3),'filled');
        xlabel('Acetate');
        ylabel('Adenine');
        axis([-1000 1000 -30 30]);
        subplot(7,7,24)
        ...
        axis([-1000 1000 -30 30]);
        subplot(7,7,37)
        scatter(FluxDataCN(6,2,:,1),FluxDataCN(6,2,:,2),50,reshape(FluxDataCNcolor(6,2,:,:),50,3),'filled');
        xlabel('Fructose');
        ylabel('Adenine');
        axis([-1000 1000 -30 30]);
        subplot(7,7,38)
